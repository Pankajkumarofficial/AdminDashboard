...
function TableHoc<T extends Object>(columns: Column<T>[], data: T[], containerClass: string, heading: string, showPagination: boolean = false) {
    return function HOC() {
                            ...
                            <tr {...headerGroup.getHeaderGroupProps()}>
                                {headerGroup.headers.map((column) => (
                                    <th {...column.getHeaderProps(column.getSortByToggleProps())}>
                                        ...
                                        {
                                            column.isSorted && <span>{column.isSorted ? <AiOutlineSortDescending /> : <AiOutlineSortAscending />}</span>
                                        }
                                    </th>
                                ))}
                            </tr>
